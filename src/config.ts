...
export const siteConfig: SiteConfig = {
	title: "Aster Lab",
	subtitle: "#Lucky_girl_Syndrome",
	siteURL: "https://asterlab.vercel.app/", // 请替换为你的站点URL，以斜杠结尾
	...
	bangumi: {
		userId: "12666635", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
		fetchOnDev: true, // 是否在开发环境下获取 Bangumi 数据（默认 false），获取前先执行 pnpm build 构建 json 文件
	},

	bilibili: {
		vmid: "700888065", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		homeText: {
			...
			title: "Welcome to Glorious' Lab", // 主页横幅主标题
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/jinlinahida",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/700888065",
					external: true,
					icon: "fa7-brands:bilibili",
				},
				{
					name: "X",
					url: "https://x.com/jinlinahida",
					external: true,
					icon: "mdi:alpha-x",
				},
			],
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		...
		},
		{
			...
			url: "https://t.me/jinlinahida",
		},
		{
			name: "Instagram",
			icon: "fa7-brands:instagram",
			url: "https://www.instagram.com/jinlinahida?igsh=MXZ2bGxhaDhtYmFsdw==",
		},
	],
};
